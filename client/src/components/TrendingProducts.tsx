            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl font-bold text-green-900">
                  {formatCurrency(displayData.reduce((sum, p) => sum + parseFloat(p.profitPotential), 0) / displayData.length)}
                </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl font-bold text-purple-900">
                  {Math.round(displayData.reduce((sum, p) => sum + p.trendScore, 0) / displayData.length)}
                </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl font-bold text-orange-900">
                  {Math.round(displayData.reduce((sum, p) => sum + p.searchVolume, 0) / displayData.length / 1000)}K
                </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-sm text-slate-600">
                      <div>{product.searchVolume.toLocaleString()} qidiruv/oy</div>
                    </div>
                  </div>
                </div>
              </div>
